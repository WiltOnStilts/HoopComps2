...
export const EYE_COLOR_IDS = ["blue", "green", "brown"];
export const EYEBROW_COLOR_IDS = ["black", "brown", "tan"];
...
export function normalizeAvatarState(state) {
  ...
  if (sel.eyeColor === "black" || sel.eyeColor === "tan") sel.eyeColor = "brown";
  if (!EYE_COLOR_IDS.includes(sel.eyeColor)) sel.eyeColor = defaults.eyeColor;
