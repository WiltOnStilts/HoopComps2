...
export async function marketplaceInsightsSold(token, query) {
  ...
  if (status === 403 || status === 401) {
    return {
      ...
      error:
        "eBay sold-price API requires Marketplace Insights approval. Use the eBay Sold or 130point links below.",
      items: [],
      stats: null,
    };
  }
...
export const SOLD_DEPRECATION_NOTE =
  "eBay retired the old Finding API for sold items. Live sold comps need Marketplace Insights access, or use the scout links (eBay Sold, 130point).";
