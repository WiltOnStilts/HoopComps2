...
const careers = [
  ...
  career("Elvin Hayes", 1945, 1968, "PF", ["PF", "C"], peak(93, 45, 42, 58, 99, 99, 73), [stint("rockets", 1968, 1972), stint("wizards", 1972, 1981), stint("rockets", 1981, 1984)], [1970, 1971, 1972, 1973, 1974, 1975, 1976, 1977, 1978, 1979, 1980, 1981]),
  career("Wes Unseld", 1946, 1968, "C", ["C", "PF"], peak(72, 55, 82, 78, 99, 92, 86), [stint("wizards", 1968, 1981)], [1969, 1970, 1971, 1972, 1973, 1974, 1975, 1976, 1977, 1978, 1979, 1980, 1981]),
  career("Bob McAdoo", 1951, 1972, "PF", ["PF", "C"], peak(92, 78, 68, 62, 88, 85, 88), [stint("braves", 1972, 1976), stint("knicks", 1976, 1979), stint("celtics", 1979, 1980), stint("pistons", 1980, 1981), stint("nets", 1981, 1982), stint("lakers", 1982, 1985), stint("76ers", 1985, 1986)], [1973, 1974, 1975, 1976, 1977, 1978, 1979, 1980, 1981, 1982, 1983, 1984, 1985]),
